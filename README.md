...
# Kubernetes The Hard Way On Azure using ARM Templates

This tutorial walks you through setting up Kubernetes the hard way on Azure Using ARM Templates
This guide is not for people looking for a fully automated command to bring up a Kubernetes cluster.
If that's you then most of cloud provider provide automated kubernetes solutions.
